...
error_code_e print_equation          (const coefficients_s coefs);
...
error_code_e run_test_with_sol       (const solutions_s ref_sol);
...
coefficients_s restoring_coefficients(const solutions_s sol);
